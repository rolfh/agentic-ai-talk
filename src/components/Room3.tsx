...
export const Room3 = () => {
  ...
  const retroComputerRoomTexture = useTexture("/artwork/retro_computer_room.jpg");
  ...
  return (
    <group>
      ...
      {/* Painting 5: retro_computer_room (on North brick wall behind Station 3) */}
      <Painting
        position={[-3.5, 5.0, -8.78]}
        rotation={[0, 0, 0]}
        texture={retroComputerRoomTexture}
        width={6.0}
        height={4.0}
...
useTexture.preload("/artwork/retro_computer_room.jpg");
